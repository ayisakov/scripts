...
# Written by J. A. McNaughton, adapted by Artem Isakov
# Source URL: https://raw.githubusercontent.com/jamcnaughton/useful-linux-scripts/master/xscreensaver/xscreensaverstopperany.sh
